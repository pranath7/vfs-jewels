...
INPUT_DIR = r'C:\Users\91636\.gemini\antigravity-ide\scratch\cleaned_chains04'
...
def main():
    ...
    print(f"[FILES] Found {len(files)} cleaned chain04 images in {INPUT_DIR}")
    ...
    for i, file_name in enumerate(files):
        img_key = f"vfschain04/{file_name}"
